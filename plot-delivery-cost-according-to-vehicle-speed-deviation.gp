#plot-delivery-cost-according-to-vehicle-speed-deviation.gp

set terminal postscript eps 35
set output "./figure/performance-comparison-of-delivery-cost-according-to-vehicle-speed-deviation.eps"
set autoscale
set xrange [1:10]
set yrange [0:50]
