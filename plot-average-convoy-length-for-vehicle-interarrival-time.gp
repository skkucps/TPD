#plot-average-convoy-length-for-vehicle-interarrival-time.gp

set terminal postscript eps 35
set output "./figure/ACL-comparison-for-one-way-traffic.eps"
set autoscale
set xrange [0:20]
#set yrange [0:1000]
set xlabel "Vehicle Inter-arrival Time[sec]" font "Times-Roman,42"
set ylabel "Avg. Forwarding Distance[m]" font "Times-Roman,42"
#set xtic auto
set xtics 0,2
#set ytic auto
set ytics 0,100
