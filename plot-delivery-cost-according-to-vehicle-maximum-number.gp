#plot-delivery-cost-according-to-vehicle-maximum-number.gp

set terminal postscript eps 35
set output "./figure/performance-comparison-of-delivery-cost-according-to-vehicle-maximum-number.eps"
set autoscale
set xrange [50:500]
set yrange [0:50]
